...
class AddEncounterPage extends StatefulWidget {
  const AddEncounterPage({super.key});
  @override
  _AddEncounterPageState createState() => _AddEncounterPageState();
}

class _AddEncounterPageState extends State<AddEncounterPage> {
  final GlobalKey _dateFieldKey = GlobalKey();
  String selectedVisitType = 'Initial Eval';
  String selectedGender = '';
  String selectedOption = "signoff";
  ...
  OverlayEntry _createOverlayEntry() {
    // ✅ Use key to get correct position of the date field
    RenderBox renderBox = _dateFieldKey.currentContext!.findRenderObject() as RenderBox;
      ...
      builder: (context) => Positioned(
        ...
        child: Material(
          ...
          child: CalendarDatePicker(
            ...
            // ✅ Set allowed range
            firstDate: DateTime.now().subtract(const Duration(days: 366)), // Today - 366 days
            lastDate: DateTime.now().add(const Duration(days: 7)),          // Today + 7 days
            onDateChanged: (date) {
              setState(() {
                selectedDate = date;
                _dateController.text = _formatDate(date);
              });
              _toggleCalendar(); // close after selection
            },
          ),
        ),
      ),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              /// Encounter Date section with fixed width 250
              ...
              CompositedTransformTarget(
                ...
                child: SizedBox(
                  width: 250,
                  key: _dateFieldKey, // <-- Added key here
              ...
              const SizedBox(height: 40), // Space between date and visit type
