...
class EditEncounterNPPPage extends StatefulWidget {
  const EditEncounterNPPPage({super.key});

  @override
  _EditEncounterNPPPageState createState() => _EditEncounterNPPPageState();
}

class _EditEncounterNPPPageState extends State<EditEncounterNPPPage> {
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const Text("Select Patient", style: TextStyle(fontWeight: FontWeight.w500, fontSize: 12)),
              ...
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const Text("Encounter Date", style: TextStyle(fontWeight: FontWeight.w500, fontSize: 12)),
                    const SizedBox(height: 8),
                    TextFormField(
                    ...
                    const Text("Visit Type", style: TextStyle(fontWeight: FontWeight.w500, fontSize: 12)),
                    const SizedBox(height: 8),
                    Row(
                      children: [
                        Flexible(
      ...
      child: Column(
        ...
        children: [
          ...
          RadioListTile<String>(
            ...
            onChanged: (value) {},
            title: const Text("Sign-Off & Complete", style: TextStyle(fontSize: 12)),
            contentPadding: EdgeInsets.zero,
            dense: true,
            activeColor: Colors.blue, // 🎯 Custom color
          ),
          RadioListTile<String>(
            value: "attest",
            groupValue: selectedOption,
            onChanged: (value) {},
            title: const Text("I Attest", style: TextStyle(fontSize: 12)),
            contentPadding: EdgeInsets.zero,
            dense: true,
            activeColor: Colors.blue, // 🎯 Custom color
          ),
          RadioListTile<String>(
            ...
            groupValue: selectedOption,
            onChanged: (value) {},
            title: const Text("Reviewed without Signature", style: TextStyle(fontSize: 12)),
            contentPadding: EdgeInsets.zero,
            dense: true,
            activeColor: Colors.blue, // 🎯 Custom color
          ),
